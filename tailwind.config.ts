  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-breathe": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsl(43 80% 52% / 0.2), 0 0 40px -10px hsl(270 50% 50% / 0.1)" },
          "50%": { boxShadow: "0 0 40px -5px hsl(43 80% 52% / 0.4), 0 0 80px -10px hsl(270 50% 50% / 0.2)" },
        },
        "fade-up": {
